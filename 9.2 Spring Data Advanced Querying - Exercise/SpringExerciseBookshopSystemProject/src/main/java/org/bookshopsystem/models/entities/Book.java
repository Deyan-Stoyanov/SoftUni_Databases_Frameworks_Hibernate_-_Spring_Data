...
@Entity
@Table(name = "books")
@NamedStoredProcedureQuery(name = "usp_total_books",
        procedureName = "usp_total_books",
        parameters = {
                ...
                @StoredProcedureParameter(mode = ParameterMode.OUT, name = "number_of_books", type = Integer.class)
        })
public class Book {
