...
public interface SaleRepository extends JpaRepository<Sale,Long> {
    ...
    @Query(value = "SELECT new car.dealer.model.dto.CustomerViewModel(c.name, count(s.id), sum (p.price)) FROM Sale as s LEFT JOIN s.customer AS c JOIN s.car.parts AS p GROUP BY s.customer")
