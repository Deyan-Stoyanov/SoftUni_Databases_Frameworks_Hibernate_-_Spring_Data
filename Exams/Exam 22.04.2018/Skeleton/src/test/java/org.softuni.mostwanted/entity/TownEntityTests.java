...
public class TownEntityTests {
    ...
    public void townEntity_ShouldHaveIdAnnotation() {
        ...
        Assert.assertTrue("No Id annotation detected on Town entity.", hasId);
    }
    ...
    public void townEntity_NameFieldShouldBeRequired() {
        ...
        Assert.assertTrue("No Required configuration on \"" + fieldName + "\" field detected in Town entity.", hasNameRequired);
    }
}
